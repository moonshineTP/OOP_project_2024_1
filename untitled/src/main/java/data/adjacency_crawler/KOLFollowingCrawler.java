...
/**
 * This class is used to crawl the following KOLs of the inspected KOL and add the info to this KOL's
 * following KOL list;
 */
...
public class KOLFollowingCrawler extends Crawler {
      ...
      public void navigate() {
            System.out.print("/// Inspecting following KOLs: ");
      ...
      public boolean crawl () {
            ...
            /// Finish
            System.out.println(STR."\{kol_count} KOLs found\n");
