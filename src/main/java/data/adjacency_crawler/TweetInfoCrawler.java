...
/**
 * This class is used to check if the tweet satisfies the benchmark, return false if not.
 * Otherwise, it initializes a Tweet, adds the necessary info and push that into the tweet_data
 * json object.
 * The tweet must satisfy these benchmark to be considered a good tweet:
 *    - Minimum view: 10000
 *    - Minimum likes: 100
 *    - Minimum comment: 10
 */
